...
## Gold/Silver Ratio
- Current GSR: **61.0** — Zone: **NORMAL**
- GSR 61.0 -- silver at fair value relative to gold

## Safety Margin (Miner P/B)
| Ticker | P/B | OpMargin |
|--------|-----|----------|
| AG | 5.05 | 49.0% |
| PAAS | 3.71 | 34.9% |
...
Silver miners P/B=4.38, OpMargin=41.9% -- extreme profitability; price far above AISC; no safety margin
...
## Composite Signal
**<<< STRONG SELL >>>** — Score: -4, Confidence: 4/5

- Real Yield +1.76% (High -- headwind)
- GSR 61.0 (Normal range)
