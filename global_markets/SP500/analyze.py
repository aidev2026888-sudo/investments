"""
S&P 500 (US) — Valuation Analysis

Analyzes the S&P 500 index using SPY ETF data from yfinance.
...
CONFIG = IndexConfig(
    ...
    ticker="^GSPC",
    etf_ticker="SPY",
    bond_yield_ticker="^TNX",      # US 10-Year Treasury Yield
    currency="USD",
    country="US",
    years_back=10,
...
def main():
    ...
    # 4b. VIX Fear Gauge (informational, not scored)
    ...
    print_report(
        ...
        pe_percentile_values=pe_percentile_values,
        cape_value=cape_value,
        cape_deviation=cape_deviation,
